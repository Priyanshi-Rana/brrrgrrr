...
function renderIngredientsBoard() {
  if(state.Patty){
    document.getElementById("patty1").classList.remove("hide")
  }
  else{
    document.getElementById("patty1").classList.add("hide")
  }
  if(state.Cheese){
    document.getElementById("cheese1").classList.remove("hide")
  }
  else{
    document.getElementById("cheese1").classList.add("hide")
  }
  if(state.Onions){
    document.getElementById("onion1").classList.remove("hide")
  }
  else{
    document.getElementById("onion1").classList.add("hide")
  }
  if(state.Tomatoes){
    document.getElementById("tomato1").classList.remove("hide")
  }
  else{
    document.getElementById("tomato1").classList.add("hide")
  }
  if(state.Lettuce){
    document.getElementById("lettuce1").classList.remove("hide")
  }
  else{
    document.getElementById("lettuce1").classList.add("hide")
  }
